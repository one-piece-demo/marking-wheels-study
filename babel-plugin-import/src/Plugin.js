...
export default class Plugin {
  constructor(
    libraryName, // 库名
    libraryDirectory, // 源码文件夹
    style, // 样式
    styleLibraryDirectory, // 样式文件夹
    customStyleName, // 自定义样式名
    camel2DashComponentName, // 组件名是否驼峰
    camel2UnderlineComponentName, // 组件名下划线
    fileName,
    customName, // 自定义名称
    transformToDefaultImport, // 模块没有默认导出，则将此选项设置为false
    types,
    index = 0, // 多个库索引
  ) {
